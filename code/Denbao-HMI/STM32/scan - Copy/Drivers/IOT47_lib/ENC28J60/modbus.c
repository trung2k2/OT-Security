...
//		}	
					if (t<=5){
				modbus_Struct_Frame->data[13] = 0x42;
				modbus_Struct_Frame->data[14] = 0xfe;
				t++;}
				else if(t>=5 && t<=10){
				modbus_Struct_Frame->data[13] = 0x00;
				...
				for (i=0;i<data_length-17;i++)
				{
					modbus_Struct_Frame->data[i+17]=data_ref[i];
				}
