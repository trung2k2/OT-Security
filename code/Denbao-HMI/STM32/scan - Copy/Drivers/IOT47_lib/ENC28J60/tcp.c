...
memcpy(mac_2,TCP_Struct_Frame->MAC_nguon,4);
    ...
    if((t == 1 && TCP_Struct_Frame->Source_Port==62977)||(t == 1 && TCP_Struct_Frame->Dest_Port==62977))
		{
			ARP_table_setIP_scan(TCP_Struct_Frame->SourceIP,TCP_Struct_Frame->MAC_nguon);
			ARP_table_setIP_scan(TCP_Struct_Frame->DestIP,TCP_Struct_Frame->MAC_dich);
		}
